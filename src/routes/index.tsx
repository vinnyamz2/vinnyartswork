...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Vinny Arts — Sites, Design e Comunicação Visual" },
      { name: "description", content: "Sites premium, gestão de redes sociais, design gráfico, fachadas e comunicação visual com qualidade profissional." },
      { property: "og:title", content: "Vinny Arts — Sites, Design e Comunicação Visual" },
      { property: "og:description", content: "Soluções criativas que impulsionam sua marca." },
    ],
  }),
  component: Index,
});

const WHATSAPP_URL = "https://wa.me/5500000000000?text=Ol%C3%A1%2C%20quero%20um%20or%C3%A7amento%20com%20a%20Vinny%20Arts";
const INSTAGRAM_URL = "https://instagram.com";
const EMAIL = "contato@vinnyarts.com.br";
...
const works = [
  { type: "image" as const, src: work1, label: "Social Media — Shopbox" },
  { type: "image" as const, src: work4, label: "Manutenção Preventiva" },
  { type: "video" as const, src: "/videos/reel-1.mp4", label: "Reel — Motion" },
  { type: "image" as const, src: work2, label: "Controle Xbox" },
  { type: "image" as const, src: work3, label: "Loja Shopbox" },
  { type: "video" as const, src: "/videos/reel-2.mp4", label: "Reel — Animação" },
  { type: "image" as const, src: work5, label: "Raspadinha — Afiliados" },
  { type: "image" as const, src: work6, label: "Nicho Hot Network" },
];
...
function Index() {
  return (
    <div className="relative min-h-screen bg-background text-foreground">
      ...
      {/* HERO */}
      <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-hero pt-28">
        ...
        <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
          ...
          >
            <div className="relative animate-float">
              ...
              <img src={logo} alt="Vinny Arts" className="relative h-28 md:h-36 w-auto drop-shadow-[0_0_30px_oklch(0.72_0.21_45/0.8)]" />
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 rounded-full glass px-4 py-1.5 text-xs uppercase tracking-[0.25em] text-muted-foreground mb-6"
          >
            <span className="h-1.5 w-1.5 rounded-full bg-primary shadow-glow-sm animate-pulse-glow" />
            Vinny Arts — Estúdio Criativo
          </motion.div>
          ...
          >
            Sua marca <br />
            <span className="text-gradient">brilhando além</span> <br />
            do esperado.
          </motion.h1>
          ...
          >
            Do digital ao impresso — sites, identidade visual, redes sociais e fachadas que colocam sua empresa em outro nível.
          </motion.p>
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 text-xs uppercase tracking-[0.3em] text-muted-foreground/70 animate-pulse-glow">
          scroll
        </div>
      </section>
      ...
      <section id="servicos" className="relative py-32 overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <p className="text-xs uppercase tracking-[0.3em] text-primary mb-4">02 — Serviços</p>
            <h2 className="text-4xl md:text-6xl font-bold leading-tight">
              Tudo que sua marca <span className="text-gradient">precisa</span>, em um só lugar.
            </h2>
          </motion.div>
      ...
      {/* TRABALHOS */}
      <section id="trabalhos" className="relative py-32 overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          <motion.div
            ...
            className="max-w-2xl mb-16"
          >
            <p className="text-xs uppercase tracking-[0.3em] text-primary mb-4">03 — Trabalhos</p>
            <h2 className="text-4xl md:text-6xl font-bold leading-tight">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-5">
            {works.map((w, i) => (
              <motion.div
                ...
                className="group relative aspect-[4/5] overflow-hidden rounded-2xl glass shadow-card hover-lift"
              >
                {w.type === "image" ? (
                  <img src={w.src} alt={w.label} className="absolute inset-0 h-full w-full object-cover transition-transform duration-700 group-hover:scale-110" loading="lazy" />
                ) : (
                  <>
                    <video
                      src={w.src}
      ...
      {/* SITES */}
      <section id="sites" className="relative py-32 overflow-hidden">
